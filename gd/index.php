...
if ($sourceRatio>$destRatio){
    ...
    $newHauteur = $hauteur_destination;
    $destX = -1*($newLargeur - $largeur_destination) /2;
    $destY = 0;
}else{
    $divider = $largeur_source/$largeur_destination;
    $newLargeur = $largeur_destination;
    $newHauteur = $hauteur_source / $divider;
    $destX = 0;
    $destY = -1*($newHauteur - $hauteur_destination) /2;
}




imagecopyresampled($destination, $source, $destX, $destY, 0, 0, $newLargeur, $newHauteur, $largeur_source , $hauteur_source);
